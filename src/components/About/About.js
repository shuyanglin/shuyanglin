...
function About() {
  ...
  <Container>
    <Row>
      ...
      <Col lg={8} sm={12}>
      <p>
        Hi there, I am Shu, an independent re:architect. I have a passion for building consensus on a large scale. My specialty is designing interactions and discovering elegant solutions through an iterative process of creating and testing prototypes that foster digital democracy. With today’s technology, I believe we can find consensus on a national scale.
      </p>
      <p>
